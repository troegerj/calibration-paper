...
class TestDomain1DWithSolution(unittest.TestCase):
    ...
    def setUp(self) -> None:
        ...
        fake_observation_data = FakeObservationData1D(data_reader, None)
        fake_force_data = FakeForceData1D(data_reader, None)
        fake_solution_data = FakeSolutionData1D(data_reader, None)
        ...
        self._sut = Domain1DWithSolution(
            observation_data=fake_observation_data,
    ...
    def test_select_training_data_number_of_points(self) -> None:
        """
        Test that the number of training points is passed correctly to the data selection function.
        """
    ...
    def test_select_validation_data_number_of_points(self) -> None:
        ...
        expected = [self._num_data_points, self._num_data_points, self._num_data_points]
        assert_equal(self=self, expected=expected, actual=actual)
...
class TestDomain1DWithoutSolution(unittest.TestCase):
    def __init__(self, methodName: str) -> None:
        super().__init__(methodName=methodName)
    ...
    def setUp(self) -> None:
        ...
        self._sut = Domain1DWithoutSolution(
            observation_data=fake_observation_data,
            force_data=fake_force_data,
