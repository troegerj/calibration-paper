function dcost_vec_dutheta = dcost_vec_aao(theta,u,reaction,u_exp,mesh,lambda_r,lambda_d,varargin)
...
[~, dcost_vec_dutheta] = cost_vec_aao(theta,u,reaction,u_exp,mesh,lambda_r,lambda_d, ...
