function [model,coord,inz,bcond,load,lfun] = hyperelas_plate_with_hole_IH(matpar)
% DESCRIPTION
%  input file for hyperelastic plate with a hole using Isihara model
...
% Isihara hyperelasticity with material parameters
%  matpar(1) - bulk modulus [N/mm^2]
%  matpar(2) - c_10 [N/mm^2]
%  matpar(3) - c_01 [N/mm^2]
%  matpar(4) - c_20 [N/mm^2]
model.matpar = matpar;
model.matfun = @stct_Isihara;
