function [stress,strain,ct,q,yieldval] = stct_NeoHooke(matpar,defGrad,dt,qn,problemtype2D)
% DESCRIPTION
%  Material routine for finite strain hyperelasticity using Neo-Hookean
%  ansatz for the isochoric part of the strain energy density:
%  w(IBq,IIBq) = c10(IBq-3)
...
%  Neo-Hooke: w(IBq,IIBq) = c10(IBq-3) 
w1 = c10; % dw/dIBq
w2 = 0; % dw/dIIBq
w11 = 0; % d^2w/dIBq^2
