function [stress,strain,ct,q,yieldval] = stct_Isihara(matpar,defGrad,dt,qn,problemtype2D)
% DESCRIPTION
%  Material routine for finite strain hyperelasticity using Isihara
%  ansatz for the isochoric part of the strain energy density:
%  w(IBq,IIBq) = c10(IBq-3) + c01(IIBq-3) + c20(IBq-3)^2
...
%  Isihara: w(IBq,IIBq) = c10(IBq-3) + c01(IIBq-3) + c20(IBq-3)^2 
w1 = c10 + 2*c20*(IBq-3); % dw/dIBq
w2 = c01; % dw/dIIBq
w11 = 2*c20; % d^2w/dIBq^2
w12 = 0; % d^2w/(dIBq dIIBq)
w22 = 0; % d^2w/dIIBq^2
